...
HMS_APP_ACCESS_KEY = os.getenv("HMS_APP_ACCESS_KEY", "").strip()
HMS_APP_SECRET = os.getenv("HMS_APP_SECRET", "").strip()
HMS_TEMPLATE_ID = os.getenv("HMS_TEMPLATE_ID", "").strip()
HMS_ROOM_ID = os.getenv("HMS_ROOM_ID", "").strip()
