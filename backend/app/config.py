...
AGORA_APP_ID = os.getenv("AGORA_APP_ID", "4529ce21b87548c28408b0a7eb740b44").strip()
AGORA_APP_CERTIFICATE = os.getenv("AGORA_APP_CERTIFICATE", "910d7c6155324ef7a0cc5953848fcf3f").strip()
